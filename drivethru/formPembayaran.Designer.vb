...
Partial Class formPembayaran
    ...
    Private Sub InitializeComponent()
        ...
        tblbtnPembayaran = New TableLayoutPanel()
        ...
        ' tblbtnPembayaran
        ' 
        tblbtnPembayaran.AutoSize = True
        tblbtnPembayaran.AutoSizeMode = AutoSizeMode.GrowAndShrink
        tblbtnPembayaran.ColumnCount = 3
        tblbtnPembayaran.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 33.3333321F))
        tblbtnPembayaran.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 33.3333321F))
        tblbtnPembayaran.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 33.3333321F))
        tblbtnPembayaran.Controls.Add(btn1, 0, 0)
        tblbtnPembayaran.Controls.Add(btn2, 1, 0)
        tblbtnPembayaran.Controls.Add(btnPembayaranDel, 2, 3)
        tblbtnPembayaran.Controls.Add(btn3, 2, 0)
        tblbtnPembayaran.Controls.Add(btn0, 1, 3)
        tblbtnPembayaran.Controls.Add(btn6, 2, 1)
        tblbtnPembayaran.Controls.Add(btnPembayaranEnter, 0, 3)
        tblbtnPembayaran.Controls.Add(btn9, 2, 2)
        tblbtnPembayaran.Controls.Add(btn4, 0, 1)
        tblbtnPembayaran.Controls.Add(btn8, 1, 2)
        tblbtnPembayaran.Controls.Add(btn5, 1, 1)
        tblbtnPembayaran.Controls.Add(btn7, 0, 2)
        tblbtnPembayaran.Location = New Point(13, 6)
        tblbtnPembayaran.Name = "tblbtnPembayaran"
        tblbtnPembayaran.RowCount = 4
        tblbtnPembayaran.RowStyles.Add(New RowStyle(SizeType.Percent, 25F))
        tblbtnPembayaran.RowStyles.Add(New RowStyle(SizeType.Percent, 25F))
        tblbtnPembayaran.RowStyles.Add(New RowStyle(SizeType.Percent, 25F))
        tblbtnPembayaran.RowStyles.Add(New RowStyle(SizeType.Percent, 25F))
        tblbtnPembayaran.Size = New Size(372, 496)
        tblbtnPembayaran.TabIndex = 0
        ' 
        ' Guna2ShadowPanel1
        ' 
        ...
        Guna2ShadowPanel1.Location = New Point(516, 3)
        Guna2ShadowPanel1.Name = "Guna2ShadowPanel1"
        Guna2ShadowPanel1.Radius = 15
        Guna2ShadowPanel1.ShadowColor = Color.Black
        Guna2ShadowPanel1.Size = New Size(400, 510)
        Guna2ShadowPanel1.TabIndex = 1
        ' 
        ' Label1
        ' 
        Label1.AutoSize = True
        Label1.Font = New Font("Montserrat", 11.999999F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ...
        lvTotal.TabIndex = 3
        lvTotal.UseCompatibleStateImageBehavior = False
        ' 
        ' TableLayoutPanel1
        ' 
        ...
        TableLayoutPanel1.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 15.66265F))
        TableLayoutPanel1.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 84.33735F))
        TableLayoutPanel1.Controls.Add(lblKembalian, 2, 3)
        TableLayoutPanel1.Controls.Add(lblJumlahUang, 2, 2)
        TableLayoutPanel1.Controls.Add(lblTotalPembelian, 2, 1)
        TableLayoutPanel1.Controls.Add(lblIdTransaksi, 2, 0)
        ...
        Label2.Font = New Font("Montserrat", 11.999999F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label2.Location = New Point(3, 37)
        Label2.Name = "Label2"
        Label2.Size = New Size(222, 38)
        Label2.TabIndex = 3
        Label2.Text = "Total Pembelian"
        ' 
        ' Label3
        ' 
        Label3.AutoSize = True
        Label3.Font = New Font("Montserrat", 11.999999F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label3.Location = New Point(3, 75)
        Label3.Name = "Label3"
        Label3.Size = New Size(185, 38)
        Label3.TabIndex = 4
        Label3.Text = "Jumlah Uang"
        ' 
        ' Label4
        ' 
        Label4.AutoSize = True
        Label4.Font = New Font("Montserrat", 11.999999F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ...
        Label6.Font = New Font("Montserrat", 11.999999F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label6.Location = New Point(236, 37)
        Label6.Name = "Label6"
        ...
        Label7.Font = New Font("Montserrat", 11.999999F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label7.Location = New Point(236, 75)
        Label7.Name = "Label7"
        Label7.Size = New Size(23, 38)
        Label7.TabIndex = 8
        Label7.Text = ":"
        ' 
        ' Label8
        ...
        Label8.Font = New Font("Montserrat", 11.999999F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label8.Location = New Point(236, 113)
        Label8.Name = "Label8"
        ...
        Controls.Add(lvTotal)
        Controls.Add(Guna2ShadowPanel1)
        Name = "formPembayaran"
        StartPosition = FormStartPosition.CenterScreen
        Text = "formPembayaran"
        tblbtnPembayaran.ResumeLayout(False)
    ...
    Friend WithEvents btnPembayaranDel As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents btn0 As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents btnPembayaranEnter As Guna.UI2.WinForms.Guna2Button
    ...
    Friend WithEvents tblbtnPembayaran As TableLayoutPanel
    Friend WithEvents Guna2ShadowPanel1 As Guna.UI2.WinForms.Guna2ShadowPanel
    Friend WithEvents Label1 As Label
    Friend WithEvents lvTotal As ListView
    ...
    Friend WithEvents lblTotalPembelian As Label
End Class
